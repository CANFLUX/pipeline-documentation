...
**If you followed the quick-start database creation in section 5.1, you should skip this section, unless you have more raw data with a different format to convert.** 
