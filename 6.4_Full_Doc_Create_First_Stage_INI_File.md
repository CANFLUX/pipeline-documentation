...
Once your INI file is complete, if desired you can use the `simplify_FirstStageIni()` function to clean it up. This function removes obsolete fields (maybe helpful if you used a legacy INI file example), and makes things more concise.
